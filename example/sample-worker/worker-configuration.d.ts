/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 82612529df39dc6414479adc03c3b6a0)
// Runtime types generated with workerd@1.20260625.1 2026-06-28 nodejs_compat
interface __BaseEnv_Env {
	CONDUIT_SECRET: string;
	CONDUIT_DO: DurableObjectNamespace<import("./src/index").ConduitDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ConduitDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONDUIT_SECRET">> {}
}
